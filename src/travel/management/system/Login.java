...
public class Login extends JFrame implements ActionListener {
    ...
    Login() {
        ...
        setSize(900, 400);
        setLocation(350, 200);
        setLayout(null);//Making layout custom
        
        getContentPane().setBackground(Color.WHITE);
        
        //Dividing Login frame into two parts and adding blue background color on left part
    ...
    public static void main(String[] args) {
        new Login(); //Instantiating anonimous object
    }
}
